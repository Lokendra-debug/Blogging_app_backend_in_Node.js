        ...
        if(user){
            ...
            bcrypt.compare(password, user.password, (err, result)=> {
                ...
                if(result){
                    ...
                    const accessToken=jwt.sign({authorID:user._id,authorRole:user.role},process.env.AccessToken,{expiresIn:30})
                    const rerefreshToken=jwt.sign({authorID:user._id,authorRole:user.role},process.env.RerefreshToken,{expiresIn:60})
